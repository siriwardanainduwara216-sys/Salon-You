...
<style>
    header.site-header {
        ...
        grid-template-columns: 220px 1fr auto !important; /* Left Logo | Middle Links | Right Buttons (auto so My Appointments fits) */
...
<header class="site-header">
    ...
    <a href="index.php" class="logo-container">
        <img src="../logo/logo.png" alt="Salon You Logo" class="site-logo" style="height: 42px; width: auto;">
...
<nav class="main-nav">
    ...
    <a href="products.php" class="nav-link <?php echo ($active_page == 'products') ? 'active' : ''; ?>">Products</a>
