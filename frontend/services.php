                    ...
                    <?php foreach ($staff_list as $index =>$staff): ?>
                        ...
                        <div class="stylist-card" data-staff-id="<?php echo $staff['id']; ?>" data-staff-name="<?php echo htmlspecialchars($staff['name']); ?>">
                            ...
                            <div class="stylist-info" style="margin-top:10px;">
                                <h3 style="color:#fff; font-size:1.1rem;"><?php echo htmlspecialchars($staff['name']); ?></h3>
                                <p class="stylist-role" style="color:#d4af37; font-size:0.85rem;"><?php echo htmlspecialchars($staff['role'] ?? 'Hair Stylist'); ?></p>
                            </div>
                        </div>
                    <?php endforeach; ?>
                <?php endif; ?>
