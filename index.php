...
<body>
    <header class="site-header">
        ...
        <nav class="main-nav">
            ...
            <!-- Added Queue Tracking Link Here -->
            <a href="track-queue.php" class="nav-link"><i class="fas fa-list-ol"></i> Track Queue</a>
    ...
    <section id="ai-recommender" class="section-container ai-sectoin">
